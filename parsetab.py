...
_lr_productions = [
  ...
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression','calc.py',69),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','calc.py',70),
  ('expression -> expression PLUS expression','expression',3,'p_expression','calc.py',71),
  ('expression -> expression MINUS expression','expression',3,'p_expression','calc.py',72),
  ...
  ('empty -> <empty>','empty',0,'p_empty','calc.py',91),
]
